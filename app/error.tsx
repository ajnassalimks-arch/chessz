...
export default function ErrorBoundary({
  ...
  return (
    <div className="min-h-screen bg-[#0a0d14] text-white flex flex-col items-center justify-center p-6 text-center">
      <div className="p-5 rounded-2xl bg-rose-500/10 border border-rose-500/30 max-w-md w-full space-y-4 shadow-2xl">
        ...
        <div className="flex items-center justify-center gap-3 pt-2">
          <button
            onClick={() => reset()}
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-xs font-mono font-bold transition cursor-pointer"
          >
